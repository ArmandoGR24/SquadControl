    ...
    <div class="mx-auto flex h-full w-full max-w-5xl flex-1 flex-col gap-4 pb-[calc(env(safe-area-inset-bottom)+0.75rem)]">
      ...
      <div class="rounded-2xl border border-sidebar-border/70 bg-background p-5 shadow-sm">
        <div class="flex flex-col gap-3">
          ...
          <div v-if="parseMaterialItems(tarea.materiales).length" class="grid gap-1 text-sm text-muted-foreground">
            <p class="font-medium text-foreground">Materiales necesarios:</p>
            <p
